...
export default Ember.Controller.extend({
    ...
    resetSkills: function() {
        ...
        if (this.get('selectedTheme') === "100") {
            skills = [
            Ember.Object.create( { name: "Archery", desc: "Shooting bows and crossbows. (Reflexes)", rating: 1 }),
            Ember.Object.create( { name: "Athletics", desc: "General running, jumping, climbing, etc. (Brawn)", rating: 1 }),
            Ember.Object.create( { name: "Deception", desc: "Lies and cons. (Presence)", rating: 1 }),
            Ember.Object.create( { name: "Firearms", desc: "Shooting guns. (Reflexes)", rating: 1 }),
            Ember.Object.create( { name: "Medicine", desc: "Tending to the ill and injured. (Wits)", rating: 1 }),
            Ember.Object.create( { name: "Melee", desc: "Fighting with fists, knives, and hand-to-hand weapons. (Brawn)", rating: 1 }),
            Ember.Object.create( { name: "Persuasion", desc: "Making friends and influencing people. (Presence)", rating: 1 }),
            Ember.Object.create( { name: "Riding", desc: "Riding horses. (Brawn)", rating: 1 }),
            Ember.Object.create( { name: "Scrounge", desc: "Knowing where to look to find useful stuff in the ruins. (Wits)", rating: 1 }),
            Ember.Object.create( { name: "Stealth", desc: "Being sneaky. (Reflexes)", rating: 1 }),
            Ember.Object.create( { name: "Survival", desc: "Surviving in the wilderness, including trapping/foraging/shelters/navigation. (Wits)", rating: 1 }),
            Ember.Object.create( { name: "Tactics", desc: "Warfare and tactics. (Wits)", rating: 1 }),
            Ember.Object.create( { name: "Tinkering", desc: "Mechanical/electrical tinkering and repair. (Wits)", rating: 1 }),
            Ember.Object.create( { name: "Thrown", desc: "Thrown weapons. (Reflexes)", rating: 1 }),
            ];
        }
            ...
            skills = [
            Ember.Object.create( { name: "Athletics", desc: "General running, jumping, climbing, etc. (Brawn)", rating: 1 }),
            Ember.Object.create( { name: "Demolitions", desc: "Blowing stuff up. (Wits)", rating: 1 }),
            Ember.Object.create( { name: "Firearms", desc: "Shooting guns. (Reflexes)", rating: 1 }),
            Ember.Object.create( { name: "Medicine", desc: "Tending to the ill and injured. (Wits)", rating: 1 }),
            Ember.Object.create( { name: "Gunnery", desc: "Vehicle and heavy weapons. (Reflexes)", rating: 1 }),
            Ember.Object.create( { name: "Melee", desc: "Fighting with fists, knives, and hand-to-hand weapons. (Brawn)", rating: 1 }),
            Ember.Object.create( { name: "Piloting", desc: "Flying Vipers, Raptors and airborne vehicles. (Reflexes)", rating: 1 }),
            Ember.Object.create( { name: "Stealth", desc: "Being sneaky. (Reflexes)", rating: 1 }),
            Ember.Object.create( { name: "Tinkering", desc: "Mechanical/electrical tinkering and repair. (Wits)", rating: 1 })
            ];           
        }
